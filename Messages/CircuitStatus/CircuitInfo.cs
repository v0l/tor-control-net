...
namespace tor_control_net.Messages.CircuitStatus;
...
public record CircuitInfo
{
    ...
    public static CircuitInfo ParseLine(string line)
    {
        ...
        while (remainder != "")
        {
            ...
            {
                purpose = Tokenizer.ParseEnumValue(value, tor_control_net.Messages.CircuitStatus.Purpose.UNKNOWN);
            }
            else if (key == "HS_STATE")
            {
                hsState = Tokenizer.ParseEnumValue(value, tor_control_net.Messages.CircuitStatus.HsState.UNKNOWN);
            }
            ...
            {
                reason = Tokenizer.ParseEnumValue(value, tor_control_net.Messages.CircuitStatus.Reason.UNKNOWN);
            }
