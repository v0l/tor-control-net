...
namespace tor_control_net.Messages.Events.StatusEvents;
...
public record StatusEvent : IAsyncEvent
{
    ...
    public override string ToString()
    {
        ...
        return
            $"{nameof(StatusEvent)}{{{nameof(Type)}={Type}, {nameof(Severity)}={Severity}, {nameof(Action)}={Action}, {nameof(Arguments)}={{{prettyArguments}}}}}";
    }
}
