...
public class TorControlClient : IAsyncDisposable
{
    ...
    public TorControlClient(ILogger<TorControlClient> logger, TcpClient tcpClient) :
        this(logger, PipeReader.Create(tcpClient.GetStream()), PipeWriter.Create(tcpClient.GetStream()))
    {
        TcpClient = tcpClient;
    }

    internal TorControlClient(ILogger<TorControlClient> logger, PipeReader pipeReader, PipeWriter pipeWriter)
    {
        Logger = logger;
        TcpClient = null;
    ...
    private ILogger<TorControlClient> Logger { get; }
